...
plot 'output_python.csv' u 1:14 title "IgMi"
plot 'output_python.csv' u 1:15 title "IgM"
plot 'output_python.csv' u 1:16 title "IgGi"
plot 'output_python.csv' u 1:17 title "IgG"
