...
c_v1 = 2.63  # Maximum viral clearance rate by innate immune system
...
k_v2 = 2.32e-7  # Virus elimination rate per unit of CD8+ T cells
k_v3 = 6.16e-5  # Virus neutralization rate per unit of IgG antibodies
k_v4 = 2.88e-5  # Virus elimination rate per unit of innate immune cells
'''
#c_pl1 = 1.69e-1
#c_ps1 = 1.44e-2
#delta_IgM = 2.049e-1
...
def f(t,y):
    dydt = np.zeros(eq)
    dydt[0] = pi_v * y[0] - k_v1 * y[0] * y[11] - k_v2 * y[0] * y[6] - k_v3 * y[0] * y[12] - (c_v1 * y[0])/(c_v2 + y[0]) 
