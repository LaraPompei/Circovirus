...
#define pi_v 1.27            //Taxa de replicacao viral
...
#define k_v1 1.43e-5        //Taxa de neutralizacao do virus por unidade anticorpos neutralizantes
//#define k_v2 7.48e-7        //Taxa de eliminacao do virus por unidade de celulas T CD8+
#define k_v2 3.3e-7        //Taxa de eliminacao do virus por unidade de celulas T CD8+
...
#define c_ap1 3          //bem sensivel - desloca a curva dos anticorpos no eixo x
//#define c_ap2 4e1           //Constante de meia ativacao
#define c_ap2 4.5e4           //mexe no pico dos anticorpos

//#define delta_apm 5.38e-1   //Taxa de morte das APCs maduras
#define delta_apm 3.38e-1   //Taxa de morte das APCs maduras
...
#define pi_b2 1.27e-4       //Taxa de ativacao das celulas B T-dependentes

//#define beta_ps 6.72e-4     //Taxa de diferenciacao das celulas B ativas em plasmocitos de vida curta
#define beta_ps 8.62e-4     //Taxa de diferenciacao das celulas B ativas em plasmocitos de vida curta
...
#define pi_ps 1.37e-4      //Taxa de secrecao de anticorpos por unidade de plasmocitos de vida curta
