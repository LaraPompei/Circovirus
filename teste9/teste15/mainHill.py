...
beta_th = 5e-2
pi_th = 1e-3  # Replication rate of effector CD4+ T cells
...
beta_tk = 1e-3
#pi_tk = 1e-8
pi_tk = 1e-4  # Replication rate of effector CD8+ T cells
...
pi_b2 = 1.27e-5  # Activation rate of T-dependent B cells
...
delta_IgM = 2.42e-1  # Decay rate of IgM
...
def f(t,y,spline_x):
    ...
    #Apresentadora ideal
    dydt[14] = beta_ap * y[1] * ((c_ap1 * y[0]**c_ap2) / (c_ap3**c_ap2 + y[0]**c_ap2)) - delta_apm *y[14]
    #Apresentadora intermediaria    
    dydt[2] = (y[14] - y[2])/taui 
...
y0 = np.array([V0, Ap0, Apm0, Apm0, Thn0, The0, Tkn0, Tke0, B0, Ps0, Pl0, Bm0, A0, A0, Apm0])
...
labels = ['Time', 'V', 'Ap','Api', 'Apm', 'Thn', 'The', 'Tkn', 'Tke', 'B', 'Ps', 'Pl', 'Bm', 'IgM', 'IgG', 'Apm Ideal']
