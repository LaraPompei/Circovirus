...
k_v2 = 4.5e-6  # Virus elimination rate per unit of CD8+ T cells
...
beta_l = 5.2e-2  # Decay rate of innate immune cells due to virus encounter
...
beta_pl = 6.61e-4  # Differentiation rate of active B cells into long-lived plasma cells
...
gama_bm = 4.75e-2  # Differentiation rate of memory B cells into long-lived plasma cells
...
c_pl1 = 126e-5
c_pl2 = 45    #dia da subida
c_pl3 = 60.0
c_pl4 = 80.0
c_pl5 = 21.0

#delta_IgM = 4.42e-1  # Decay rate of IgM
delta_IgM = 6.32e-1  # Decay rate of IgM
...
pi_v = 2.8 
k_v1 = 1.1e-6 #5.6e-4  # Virus neutralization rate per unit of IgM antibodies
k_v2 = 0.50e-6 #4.5e-6  # Virus elimination rate per unit of CD8+ T cells
k_v3 = 1.0e-5 #9.82e-8  # Virus neutralization rate per unit of IgG antibodies
k_v4 = 0.96e-3  # Virus elimination rate per unit of innate immune cells
...
#delta_IgM = 4.42e-1  # Decay rate of IgM
delta_IgM = 7.32e-1  # Decay rate of IgM
delta_IgG = 3.39e-1  # Decay rate of IgG
...
def f(t,y):
    dydt = np.zeros(eq)
    dydt[0] = pi_v * y[0] - k_v1 * y[0] * y[11] - k_v2 * y[0] * y[6] - k_v3 * y[0] * y[12] - k_v4 * y[0] * y[2]#(c_v1 * y[0])/(c_v2 + y[0]) 
