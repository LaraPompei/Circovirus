...
c_ap3 = 20e1     # Day the APm start being produced
...
alpha_tk = 2.17e-2  # Homeostasis rate of CD8+ T cells
...
delta_ps = 2.61e-3  # Decay rate of short-lived plasma cells
delta_pl = 3.2e-6  # Decay rate of long-lived plasma cells
...
delta_IgM = 7.42e1  # Decay rate of IgM
...
def f(t,y,spline_x):
    ...
    #IgMi
    dydt[12] = (c_ps1 * y[9] - y[12])/tauIgMi
    #IgM
    dydt[13] = (c_ps2 * y[12] - y[13])/tauIgM - delta_IgM*y[13]
    #IgG 
    dydt[14] = (c_pl1 * y[10] - y[14])/tauIgG
    #IgG
    dydt[15] = c_pl2 * y[14] - delta_IgG * y[15]
    return dydt
...
y0 = np.array([V0, Ap0, Apm0, Apm0, Thn0, The0, Tkn0, Tke0, B0, Ps0, Pl0, Bm0, A0, A0, A0, A0])
...
labels = ['Time', 'V', 'Ap','Api', 'Apm', 'Thn', 'The', 'Tkn', 'Tke', 'B', 'Ps', 'Pl', 'Bm', 'IgM', 'IgMi', 'IgGi', 'IgG']
