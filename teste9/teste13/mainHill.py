...
def f(t,y,spline_x):
    ...
    dydt[2] = (beta_ap * y[1] * ((c_ap1 * y[0]**c_ap2) / (c_ap3**c_ap2 + y[0]**c_ap2)) - y[2])/taui - delta_api * y[2]
    #Apresentadora Madura 
    dydt[3] = (y[2] - y[3])/taum - delta_apm * y[3]
    #T helper naive
    ...
    #IgM
    dydt[12] = c_ps1 * ((y[9]**c_ps2) / (c_ps3** c_ps2 + y[9]**c_ps2)) - delta_IgM * y[12]
    #IgG 
