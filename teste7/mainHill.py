...
alpha_ap = 1.5e-4  # Homeostasis rate of immature APCs
...
pi_b2 = 1.27e-8  # Activation rate of T-dependent B cells
...
def f(t,y,spline_x):
    ...
    dydt[7] = alpha_b * (B0 - y[7]) + pi_b2 * y[4] * (c_ap1 * y[7]**c_ap2 / (c_ap4**c_ap2 + y[7]**c_ap2)) - beta_ps * y[2] * y[7] - beta_pl * y[4] * y[7] - beta_bm * y[4] * y[7]
